				...
				function readFile() {
					...
					for(var i = 0; i < iLen; i++) {
						...
						reader.onload = function(e) {
							...
							result = '<div class="showdiv"><img class="left" src="Arrow_left.svg" /><img class="center" src="delete.svg" /><img class="right" src="Arrow_right.svg" /></div><img id="srcimgid' + currentReViewImgIndex + '" class="showimg" src="' + this.result + '" />';
